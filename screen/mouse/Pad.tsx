...
> {
  ...
  constructor(props: PadPropsComponent) {
    ...
    this.animateOrigin = Animated.event(
      [
        null,
        {
    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderMove: (e, gesture) => {
        if (
          Math.abs(gesture.dx) - 80 >= this.props.max.x ||
          Math.abs(gesture.dy) - 80 >= this.props.max.y
        )
          this.animateOrigin(e, gesture);
